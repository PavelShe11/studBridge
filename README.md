...
Backend системы аутентификации и управления аккаунтами, построенная на микросервисной архитектуре с использованием Go. Реализован согласно [`ТЗ`](docs/ТЗ_Auth.md)
